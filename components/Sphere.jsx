...
import diaryIcon from "../public/Diary.svg";
...
const Sphere = () => {
  ...
  return (
    <section className="mx-14 bg-fixed relative text-center items-center flex gap-5 flex-col min-h-[70vh] ">
      <motion.div
        ref={ref}
        ...
        <Image src={sphere} alt="spere svg here" width={700} height={500} />
      </motion.div>
      <div className="middleGrad left-[35vw] -z-50 " />
      <h2 className="max-w-2xl pb-8">
...
const Boxes = () => {
  return (
    ...
    >
      <Image src={diaryIcon} width={130} height={130} alt="icon" />
